...
## Indice
1. [01_conceptos_fundamentales](./01_conceptos_fundamentales.md)
2. [02_interfaz_de_usuario](./02_interfaz_de_usuario.md)
3. [03_gestion_de_datos](./03_gestion_de_datos.md)
4. [04_edicion_y_crecimiento](./04_edicion_y_crecimiento.md)
5. [05_motores_visuales](./05_motores_visuales.md)
...
| :--- | :--- | :--- |
| [01](./01_conceptos_fundamentales.md) | vigente | Modelo local-first y principios |
| [02](./02_interfaz_de_usuario.md) | vigente | Workspace y paneles |
| [03](./03_gestion_de_datos.md) | vigente | Carga, guardado, import/export |
