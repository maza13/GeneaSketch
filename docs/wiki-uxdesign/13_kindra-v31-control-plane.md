# Kindra v3.1 Control Plane

## Objetivo
Este documento define la gobernanza operativa para la migracion `Kindra v3.1` (issues `065..072`) y evita drift entre:
...
- archivo: `tools/kindra-v31/validate-todo-chain.mjs`
- comando: `npm run plan:kindra-v31:validate`
