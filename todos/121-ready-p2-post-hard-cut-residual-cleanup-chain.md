...
- [ ] Child tasks `122` through `124` exist and are linked.
- [ ] The chain stays explicitly separate from the completed hard cut.
- [ ] The chain defines bounded residual cleanup scope without feature expansion.
