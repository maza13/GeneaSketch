...
- [ ] `computeLayout` respeta `input.layoutEngine`.
- [ ] Diagnosticos exponen engine efectivo y timings.
- [ ] Tests reflejan semantica real de engine.
- [ ] Sin regresion funcional en coordenadas deterministas.
- [ ] Fallback `v2 -> vnext` deja traza explicita en diagnostics.
