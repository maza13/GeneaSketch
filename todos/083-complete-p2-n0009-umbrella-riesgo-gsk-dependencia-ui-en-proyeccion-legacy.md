---
complexity: "complex"
title: "n0009-umbrella-riesgo-gsk-dependencia-ui-en-proyeccion-legacy"
...
# N0009 umbrella Riesgo GSK: dependencia UI en proyeccion legacy
...
**Actions:**
- Verificado cierre de dependencias:
  - `084`: bloqueador N0008 resuelto.
  - `085`: bloqueador N0007 resuelto.
  - `086`: contrato de proyeccion directa documentado.
  - `087`: implementacion directa + flag central + pruebas.
- Confirmado que selectors criticos operan por ruta directa con rollback central.
...
- Result: build OK
- Artifacts/paths:
  - `todos/084-complete-p2-n0009-cerrar-n0008-exponer-api-publica-para-registrar-initialimport-y-el.md`
  - `todos/085-complete-p2-n0009-cerrar-n0007-asegurar-write-path-journal-only-para-evitar-estado-f.md`
  - `todos/086-complete-p2-n0009-definir-read-model-gschema-directo-minimo-para-paneles-clave-perso.md`
  - `todos/087-complete-p2-n0009-implementar-migracion-por-fases-con-feature-flag.md`
...
- Reason: cadena completa N0009 ejecutada y validada.
