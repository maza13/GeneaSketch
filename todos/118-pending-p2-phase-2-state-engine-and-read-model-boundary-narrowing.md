...
- [ ] The store is measurably closer to a coordinator than to an engine/projection fusion point.
- [ ] Refresh and reprojection are no longer triggered from overly mixed write paths.
- [ ] The write path is more reusable for apply/share/import without broad reload patterns.
- [ ] No preserved architecture boundary regresses.
