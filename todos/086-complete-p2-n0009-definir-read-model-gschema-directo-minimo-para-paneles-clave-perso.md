---
complexity: "complex"
title: "n0009-definir-read-model-gschema-directo-minimo-para-paneles-clave-perso"
...
# N0009 Definir read-model GSchema directo minimo para paneles clave (persona, familia, timeline),
...
### 2026-03-05 - Contrato tecnico de read-model directo definido
...
**Actions:**
- Definido contrato formal de proyeccion directa para Persona/Familia/Timeline.
- Establecidas reglas de IDs (`xref` preferente, fallback por UID) y limites de fallback.
- Documentado modo central de runtime `readModelMode` y criterios de rollback.

**Evidence:**
- Command: inspeccion de contrato y wiring en codigo
- Result: contrato escrito y alineado a implementacion 087
- Artifacts/paths:
  - `docs/wiki-gsk/07_read-model-direct.md`
...
- Reason: criterio de definicion contractual cumplido con artefacto de documentacion y tipos.
