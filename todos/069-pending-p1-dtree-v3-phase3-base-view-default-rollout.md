...
- [ ] `DTreeViewV3` renderiza arbol base, seleccion, foco y colapso.
- [ ] `App` usa V3 por defecto.
- [ ] `renderVersion` persiste y restaura correctamente.
- [ ] Existe fallback temporal operativo y probado.
- [ ] Rollback a `v2` puede activarse sin romper session restore.
