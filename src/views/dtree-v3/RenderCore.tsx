...
import { KinshipBadgePanel } from "@/views/dtree-v3/ui/KinshipBadgePanel";
import { HeatmapHoverCard } from "@/views/dtree-v3/ui/HeatmapHoverCard";
import { LayerLegendPanel } from "@/views/dtree-v3/ui/LayerLegendPanel";
import { TimelineSimulationBadge } from "@/views/dtree-v3/ui/TimelineSimulationBadge";
import { LayerHoverCards } from "@/views/dtree-v3/ui/hover/LayerHoverCards";
import { OriginHoverCard } from "@/views/dtree-v3/ui/hover/OriginHoverCard";
import { DeepestHoverCard } from "@/views/dtree-v3/ui/hover/DeepestHoverCard";
import { TimelineHoverCard } from "@/views/dtree-v3/ui/hover/TimelineHoverCard";
...
export function RenderCore({
    ...
    const overlayPrecomputed = useMemo(
        () =>
            buildOverlayPrecomputedData({
                overlays: dtreeConfig?.overlays,
                document,
                graph
            }),
        [dtreeConfig?.overlays, document, graph]
    );
    ...
    const activeOverlays = dtreeConfig?.overlays ?? [];
