...
const EXTRACTION_OPTIONS: { value: ExtractDirection; label: string; desc: string }[] = [
    ...
    { value: "paternal_ancestors", label: "🛡️ Ancestros Paternos", desc: "Extrae solo la rama patrilineal (padres, abuelos paternos, etc.)." },
            ...
            <div className="modal-panel" style={{ width: 480 }} onClick={(e) => e.stopPropagation()}>
                ...
                <div style={{ padding: "0 20px" }}>
                    <p style={{ margin: "10px 0 20px 0", color: "var(--ink-muted)" }}>
                        Selecciona qué parte del árbol de <strong>{person.name} {person.surname}</strong> deseas extraer a un nuevo archivo GDZ.
                    </p>
