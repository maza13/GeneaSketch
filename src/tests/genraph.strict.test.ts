...
import { importGskPackage, exportGskPackage } from "../core/genraph/GskPackage";
import { serializeGedcom } from "../core/gedcom/serializer";
import { PersonPredicates } from "../core/genraph/predicates";
import JSZip from "jszip";
import type { GeneaDocument } from "../types/domain";

describe("Genraph Phase D2 - Hardening", () => {
    ...
    it("fails in strict mode when fast-forwarding with a non-contiguous opSeq", async () => {
        ...
        const { applyJournalOps } = await import("../core/genraph/Journal");
