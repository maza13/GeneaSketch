...
export const GraphMutations = {
    updateNoteInGraph(graph: GenraphGraph, noteUid: string, text: string, actorId = "system_ui"): boolean {
        return graph.updateNoteText(noteUid, text, actorId);
    },

    updatePersonInGraph(graph: GenraphGraph, personUid: string, patch: PersonPatch, actorId = "system_ui"): void {
    ...
    createPersonInGraph(graph: GenraphGraph, input: PersonInput, actorId = "system_ui"): { node: PersonNode } {
    ...
    linkRelationInGraph(graph: GenraphGraph, anchorUid: string, targetUid: string, type: "parent" | "child" | "spouse", targetFamilyId?: string, actorId = "system_ui"): void {
    ...
    unlinkRelationInGraph(graph: GenraphGraph, personUid: string, relatedUid: string, type: "parent" | "child" | "spouse", actorId = "system_ui"): void {
        if (type === "parent") {
    ...
    updateFamilyInGraph(graph: GenraphGraph, familyUid: string, patch: FamilyPatch, actorId = "system_ui"): void {
