/**
 * Genraph 0.1.x — Graph Integrity Validation
 *
 * Validates a GenraphGraph for structural consistency. This is used:
...
import type { GenraphGraph, GenraphEdge, GClaim } from "./types";
...
export function validateGenraphGraph(graph: GenraphGraph): ValidationResult {
 ...
 */
export function isActiveNode(graph: GenraphGraph, uid: string): boolean {
 ...
 */
export function getActiveClaims(graph: GenraphGraph, nodeUid: string, predicate: string): GClaim[] {
 ...
 */
export function getPreferredClaim(graph: GenraphGraph, nodeUid: string, predicate: string): GClaim | null {
 ...
 */
export function getPreferredValue<T>(graph: GenraphGraph, nodeUid: string, predicate: string): T | null {
