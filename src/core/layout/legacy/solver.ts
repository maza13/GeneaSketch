...
import { chooseOriginFamilyForPerson, orderFamiliesForPerson, sortSpousesForFamily } from "@/core/layout/legacy/orderRules";
import type { VirtualTreeBuildResult } from "@/core/layout/legacy/virtualTree";
...
function appendHierarchyPositions(
  ...
  hierarchy.each((rawNode: any) => {
    ...
    const logicalY = generation * input.generationStep;
