/**
 * GSchema 0.1.x — Predicate Catalog
 *
...
// ─────────────────────────────────────────────
// GEDCOM Tag ↔ GSchema Predicate Mapping
// ─────────────────────────────────────────────

/**
 * Maps a GEDCOM tag path to a GSchema predicate.
 * Tag paths use "." as separator, e.g., "INDI.BIRT.DATE".
 *
 * Bidirectional: use `gedcomToGSchema` and `gschemaToGedcom` helpers below.
 */
...
/** Reverse mapping: GSchema predicate → GEDCOM tag path. */
...
/**
 * Look up the GSchema predicate for a given GEDCOM tag path.
...
/**
 * Look up the GEDCOM tag path for a given GSchema predicate.
